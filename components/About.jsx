    ...
    <section className="w-full h-fit px-[40px] py-10 max-xs:px-[20px] relative bg-white" id="about">
      <div className="max-w-[1250px] mx-auto">
        ...
        <div className="mt-7">
          ...
          I’m a dedicated Software Developer with expertise in full-stack development using Java, Python, JavaScript, React, Node.js, Django, and Spring Boot. 
          I have successfully delivered over 20 high-impact open-source projects, demonstrating strong problem-solving abilities and innovation. 
          My skills include building scalable applications, creating responsive UIs, and managing projects using Agile methodologies, JIRA, and Git. 
