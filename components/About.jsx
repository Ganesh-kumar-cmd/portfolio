      ...
      <div className="max-w-[1250px] mx-auto">
        ...
        <div className="mt-7">
          <p className="mt-6 text-gray-600 text-[20px] leadiing-10">
            ...
            2023, I've been diving deeper every day. I've shared my journey on YouTube with over 50+ videos and have
            completed more than 10+ projects. I'm always eager to learn more and improve my skills.
          </p>
        </div>
      </div>
          ...
          <ul className="flex justify-between gap-10 flex-col md:flex-row">
            ...
            <li className="w-full shadow-sm">
              <div className="w-full text-center py-[30px] md:py-[60px] rounded-md bg-light-bg">
                <h3 className="text-[40px] mb-[3px font-bold text-dark-red">15+</h3>
